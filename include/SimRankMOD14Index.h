...
#ifndef _SIMRANKMOD14INDEX_H_
#define _SIMRANKMOD14INDEX_H_
...
class SimRankMOD14INDEX: public SimRankMethod{
public:
	SimRankMOD14INDEX(int maxsteps, int sampleNum, double decayfactor, int *graph_src, int *graph_dst, int mvid, char *graph, bool isinit,
