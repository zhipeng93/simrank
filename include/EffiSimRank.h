 ...
 ************************************************************************/
#ifndef EFFISIMRANK_H
#define EFFISIMRANK_H
...
class EffiSimRank :public SimRankMethod{
	public:
		EffiSimRank(double decayfactor,int* orig_graph_src,int* orig_graph_dst, int rank,int mvid, bool isinit,char* inpath):
