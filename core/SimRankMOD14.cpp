...
SimRankMOD14::SimRankMOD14(int maxSteps, int sampleNum, double decayfactor, int *graph_src, int *graph_dst, int mvid, char *graph):
...
void SimRankMOD14::run(int qv,int k){
...
double SimRankMOD14::calSimRank(int queryv,int otherv){
	double simrank = 0.0;
